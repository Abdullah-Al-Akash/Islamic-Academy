                ...
                <div>
                        <div className="header d-md-flex justify-content-center align-items-center">
                                <div className="p-3">
                                        ...
                                        <h4 className="slogan">To Learn Quran Properly and get Proper Meaning <br /> With proper Tajweed, the beauty of our recitation amplifies, <br /> applying all rules and characteristics correctly.</h4>
